...
import PaymentTable from "../../sales/paymentReceived/detailedPage/PaymentTable";
import JournalInvoicePayment from "../../sales/paymentReceived/detailedPage/JournalInvoicePayment";
export default function PurchaseReceiveDetailedPage() {
