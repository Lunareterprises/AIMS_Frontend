...
import { organization } from "../../api/services/authService";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        org_location: `${formData.state}, ${formData.location}`,
        state: formData.state,
        base_currency: formData.currency?.split(" - ")[0],
        ...
        tax_basis: formData.taxBasis,
        filing_frequency: formData.filingFrequency,
      };

      console.log(payload, "payloadpayload");

      const response = await organization(payload);
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col ">
        ...
        <div className="bg-white p-4 border-b flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <img
              src="/Images/AuthicationImage/avatar.jpg"
              alt="Logo"
              className="h-8"
            />
            <div>
        ...
        <div className=" bg-white flex-1 max-w-3xl mx-auto w-full px-4 py-8">
          ...
          <div className="mt-8">
            ...
            <div className="mb-6">
              ...
              <Select
                ...
                onChange={(selected) =>
                  handleChange("industry", selected.value)
                }
              />
            </div>
          ...
          <div className="bg-gray-50 p-4 border border-gray-200 rounded mb-8">
            ...
            <ul className="list-disc pl-5 space-y-3 text-sm text-gray-600">
              ...
              <li>
                The language selected here applies to key features even if
                changed later.
              </li>
            </ul>
